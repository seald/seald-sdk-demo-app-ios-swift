...
func testSealdSDK() async -> Bool {
    do {
        ...
        let resultList = try await es1SDK1.listRecipientsAsync()
        ...
        let respRevoke = try await es1SDK1.revokeRecipientsAsync(
            withSealdIds: [user3AccountInfo.userId],
            proxySessionsIds: [proxySession1.sessionId],
            symEncKeysIds: nil,
            tmrAccessIds: nil,
            tmrAccessAuthFactors: nil
        )
